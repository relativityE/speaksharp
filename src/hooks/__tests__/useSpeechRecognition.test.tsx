...
import TranscriptionService, { TranscriptionServiceOptions, _TranscriptUpdate } from '../../services/transcription/TranscriptionService';
...
describe('useSpeechRecognition', () => {
  ...
  it('should handle transcript updates from the service', async () => {
    // Use real timers for this test to avoid timer-related issues
    vi.useRealTimers();
