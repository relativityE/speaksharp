            ...
            <main className="flex-grow">
                ...
                <section className="container mx-auto px-4 py-24 text-center">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        <Button size="lg" className="text-xl font-semibold py-8 px-10" onClick={handleStartSession}>
                ...
                <section className="container mx-auto px-4 py-16 text-center bg-secondary rounded-xl">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="aspect-video bg-white rounded-lg flex items-center justify-center border-2 border-dashed border-border mb-8">
                            <p className="text-muted-foreground text-lg">Animated Demo Placeholder</p>
                        </div>
                        <div className="text-left p-6 bg-white rounded-lg border">
