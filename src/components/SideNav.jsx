        ...
        <Sheet>
            ...
            <SheetContent side="left">
                ...
                <nav className="mt-8 flex flex-col gap-4">
                    <NavLink to="/" className={({ isActive }) => `${navLinkClasses} ${isActive ? 'bg-secondary text-foreground' : ''}`} end>
                        <Home className="mr-3 h-5 w-5" />
                        Home
                    </NavLink>
                    <NavLink to="/analytics" className={({ isActive }) => `${navLinkClasses} ${isActive ? 'bg-secondary text-foreground' : ''}`}>
                    ...
                    {user ? (
                        ...
                        <NavLink to="/auth" className={({ isActive }) => `${navLinkClasses} ${isActive ? 'bg-secondary text-foreground' : ''}`}>
