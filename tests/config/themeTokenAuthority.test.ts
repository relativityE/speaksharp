...
const BASELINE_RETIRED_GREY: Record<string, number> = {
    ...
    'frontend/src/components/session/CoveragePace.tsx': 8,
    'frontend/src/components/session/CoverageThisRun.tsx': 2,
    'frontend/src/components/session/FocusPointsRail.tsx': 3,
    'frontend/src/components/session/ObjectiveSetupForm.tsx': 5,
};
...
const BASELINE_ROLE_LITERALS: Record<string, number> = {
    'frontend/src/components/AnalyticsDashboard.tsx': 11,
    ...
    'frontend/src/components/session/CoveragePace.tsx': 7,
    'frontend/src/components/session/CoverageRail.tsx': 2,
    'frontend/src/components/session/CoverageThisRun.tsx': 3,
    'frontend/src/components/session/CustomWordsBar.tsx': 4,
    'frontend/src/components/session/FillerBreakdown.tsx': 4,
    'frontend/src/components/session/FocusDeliveryStrip.tsx': 1,
    'frontend/src/components/session/FocusPointsRail.tsx': 12,
    'frontend/src/components/session/FreeformHelpOverlay.tsx': 1,
    'frontend/src/components/session/LiveTip.tsx': 3,
    'frontend/src/components/session/LiveTranscript.tsx': 4,
    'frontend/src/components/session/MicCard.tsx': 5,
    ...
    'frontend/src/components/session/ProgressVsBaseline.tsx': 9,
    'frontend/src/components/session/PromptOffer.tsx': 5,
    'frontend/src/components/session/RecorderBar.tsx': 3,
    'frontend/src/components/session/ReviewTranscriptNotice.tsx': 1,
    ...
    'frontend/src/components/session/__tests__/ProgressVsBaseline.test.tsx': 1,
