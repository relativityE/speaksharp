                    ...
                    <CardContent>
                        <form onSubmit={(e) => { void handleSubmit(e); }} className="space-y-4" data-testid="auth-form">
                            ...
                            <p className="rounded-md border border-primary/30 bg-primary/5 px-3 py-2 text-sm font-medium text-foreground">
                                Start free with instant Browser transcription. Your 60-minute Pro trial lets you try Vault Mode private transcription and deeper feedback. Cloud STT is a Pro feature (unavailable for trial).
                            </p>
