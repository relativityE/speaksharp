...
describe('TranscriptionService', () => {
    ...
    it('should sanitize transcripts effectively through mandatory pipeline (Item 7B)', async () => {
        ...
        let nativeEngine: ITranscriptionEngine | null = null;
        ...
        const onTranscriptUpdate = (nativeEngine as unknown as { onTranscriptUpdate?: (update: unknown) => void }).onTranscriptUpdate; 
