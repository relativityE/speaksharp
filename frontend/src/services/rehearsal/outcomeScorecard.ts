...
export const COVERED_RATIO = 0.7; // >= 70% of a point's keywords co-occur in one segment => Covered (evidence-strong).
export const PARTIAL_RATIO = 0.34; // >= ~1/3 => Partial (some evidence).
