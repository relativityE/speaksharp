 ...
 * of Open Mic: identical 4 fixed slots (A mic/recorder/scrubber · B transcript · C progress), the ONE
 ...
 * slot identity/position is guaranteed to match Open Mic (the shell owns the grid). STT stays Private
 * only — no engine selector, same as Open Mic.
 */

/** before — Open Mic before + the capture step in slot D. */
...
/** during — Open Mic during + the live coverage rail in slot D. */
...
/** after — Open Mic after + the resolved coverage rail in slot D (replaces the verdict). */
