                ...
                {isPrivateRetry ? (
                    ...
                    <>
                        <span className="relative flex h-3 w-3 mr-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-record opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-3 w-3 bg-record"></span>
                        </span>
                        Stop Recording
                    </>
                ) : (
