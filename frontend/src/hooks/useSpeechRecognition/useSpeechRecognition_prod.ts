...
export const useSpeechRecognition_prod = (props: UseSpeechRecognitionProps = {}) => {
    ...
    const effectivePolicyMode = isEffectiveProUser
        ...
        : 'native';
    // This compatibility hook cannot widen the production engine set. The session lifecycle's
    // server-authoritative can_start result remains the recording-access authority.
