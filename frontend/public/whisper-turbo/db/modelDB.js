    ...
    fetchBytes(url, onProgress) {
        return __awaiter(this, void 0, void 0, function* () {
            const run = () => __awaiter(this, void 0, void 0, function* () {
                ...
                // If we have content length, pre-allocate. Otherwise, collect chunks and merge later.
                const chunks = [];
                ...
                for (; ;) {
                    ...
                    if (onProgress && contentLength > 0) {
                        ...
                        // If no content length, show indeterminate progress or just count
                        onProgress(-1); // Convention for indeterminate
                    }
                }
