# Changelog Reference Archived

This historical changelog was retired because it contained obsolete entitlement implementation details that no longer match the product.
