...
- **⚠️ Custom Vocabulary E2E Test Skipped (2025-12-06):** Migrated to MSW handlers (GET/POST/DELETE), eliminating `page.route()` conflicts. Test skipped pending UI investigation (settings sheet timeout). **Status:** MSW handlers ready, test needs UI debugging. **Location:** `tests/e2e/custom-vocabulary.e2e.spec.ts:4`
...
**Last Updated:** Sat, 06 Dec 2025 13:08:28 GMT
