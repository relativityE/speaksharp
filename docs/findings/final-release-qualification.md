# Final release qualification — Q-08, Q-10
...
- **Q-08** — requirement NOT ON RECORD; no description exists in any source
- **Q-10** — requirement NOT ON RECORD; no description exists in any source
...
Neither Q-08 nor Q-10 has a description in any source I can read. This branch
cannot begin until the PM states what each one requires.
