...
// `gh secret list` / `gh variable list`: all five retired names were absent after the authorized cleanup.
// These dated exports preserve the observed names-only readback; current truth must always come from `--check`.
export const ALREADY_DELETED_AS_OF_2026_08_19 = [...RETIRED_SECRET_NAMES];
