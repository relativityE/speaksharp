...
- **Hybrid Speech Processing**: Supports both local, in-browser speech recognition for privacy and a cloud-based option (AssemblyAI) for higher accuracy. It also includes a native browser speech recognition fallback for improved robustness.
...
- **Speech Processing**:
    ...
    - **Fallback**: Native browser speech recognition API for improved robustness.
