...
-   **Bounded retention:** transcript text is retained only for the newest transcript-bearing session; every older transcript expires while session history and derived metrics remain.
