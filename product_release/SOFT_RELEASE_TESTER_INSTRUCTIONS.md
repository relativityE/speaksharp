...
Your new account includes 24 hours of trial access automatically. The timer starts when the account is created. Cloud STT is available as a Pro feature. Trial access includes Private STT, so this test focuses on Private STT.
