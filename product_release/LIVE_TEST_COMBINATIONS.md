...
| Basic user | Start/stop/save allowed within quota | Pro-gated with clear upgrade/promo path | Pro-gated with clear upgrade/promo path | Pro-gated with clear upgrade/promo path | Validate after deploying `20260521000000_basic_tier_cutover.sql`; no runtime path should emit the old unpaid-tier value. |
| Future paid Basic user | Start/stop/save allowed within paid baseline quota | Pro-gated with clear upgrade/promo path | Pro-gated with clear upgrade/promo path | Pro-gated with clear upgrade/promo path | Paid Basic pricing remains parked until current tester release is stable. |
