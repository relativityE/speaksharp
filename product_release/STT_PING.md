...
| 2026-06-06T20:19Z | V4 | **probe v3 run / harness not verdict-ready** | Ran probe v3 from `dev/v4-recovery@f30e8f7d`. Initial default `/h1_6.wav` fixture path served HTML when rooted at `frontend`; reran from repo root with real fixture `/tests/fixtures/stt-isomorphic/audio/h1_6.wav`. NULL control passed (`wallMs=7`), but local adapter `shaderF16=false`; v4 fp32e/q4d, q4/q4, q8/q8, fp32/fp32 all timed out at 90s; fp16 rejected due no fp16 support; v2-base/v2-tiny controls failed `Unsupported model type: whisper`. Evidence summary: `/private/tmp/v4-bakeoff-v3-evidence-summary.json`. Do not score v4 until v2 controls pass. | `=> dev` |
