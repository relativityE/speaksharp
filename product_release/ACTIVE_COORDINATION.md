...
```text
INTEGRATION_MAIN: origin/main@7cc9fed2
MERGE_LOCK: free
UPDATED_AT: 2026-06-07T08:50Z
...
|---|---|---:|---:|---|
| 2026-06-07T08:50Z | test-release-agent | `origin/main@7cc9fed2` | 1 coordination branch | `test/coord-close-lock-proof` doc-only closeout; merge/delete immediately after commit. |
| 2026-06-07T08:50Z | dev-agent | `origin/main@7cc9fed2` required before next handoff | 4 observed `dev/*` branches | `dev/account-recording-lease@dd1ebd3c` remains dev-owned/in-flight. `dev/ux-nav-1-draft-on-unload@75566bc3` is stale (`origin/main...branch = 45 1`) and not proof-eligible until refreshed. `dev/v4-recovery@4bbd22e8` has been tested via refreshed proof branch and failed; ball is dev. `dev/maxdepth-instrument@3de1625e` remains diagnostic/stale. |
| 2026-06-07T08:50Z | remote | `origin/main@7cc9fed2` | 0 remote feature branches | Remote branches are clean: only `origin/main`. |
