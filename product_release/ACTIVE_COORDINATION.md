...
## Current baseline
- **Product code baseline:** `main` `e9040464` (Private-first selector + opaque menu + single post-save surface merged via #1007/#1008). The frozen `v0.9.0-rc4` tag (`df909805`) is historical and is **not** the current baseline.
