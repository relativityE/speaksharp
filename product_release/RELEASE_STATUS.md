...
| Cloud Pro proof | Latest: GitHub Actions run `26762814579`, artifact `/private/tmp/pro-stt-artifact-matrix-26762814579/`; must show AssemblyAI token HTTP 200, transcript/save/history/detail proof, AI suggestions, PDF export, and Pro entitlement context. |
