# Private STT Accuracy & Latency Levers — retained decision record

> **HISTORICAL EVIDENCE.** This predecessor explains earlier experiments; it is not the current benchmark contract or model verdict. Current authority is `product_release/STT.md` and the retained model evidence index is `product_release/evidence/stt/README.md`.
