# STT Speed, Accuracy, And Market Survival — 2026-06-02 (historical)
...
| 6 | Cloud baseline proof | **Smoke complete 2026-06-04:** local baseline contract/timing proof `44/44`; deployed GitHub Actions smoke run `26960691857` passed `1/1` with provider partial/final/terminated events, save, and analytics history. No standard-filler keyterms work. Full WER/tail/readability metric proof is deferred behind Native/Private. |
...
```text
product_release/evidence/stt/reports/NATIVE_STT_RELEASE_EVIDENCE_2026-06-02.md
product_release/evidence/stt/reports/PRIVATE_STT_RELEASE_EVIDENCE_2026-06-02.md
product_release/evidence/stt/reports/CLOUD_STT_RELEASE_EVIDENCE_2026-06-02.md
product_release/evidence/stt/reports/stt_product_metrics_release_matrix_2026-06-02.md
product_release/evidence/stt/reports/stt_product_metrics_release_matrix_2026-06-02.json
```
