# Active Coordination — archived predecessor
...
| #1304 — frozen selection benchmark | **RUNNING** on `main@0e2fffd1`. **600 utterances / 10,894 normalized words.** No ranking exists yet; never describe this as a 600-word test. |
...
4. **RUNNING** — the frozen **600-utterance / 10,894-normalized-word** benchmark on `main@0e2fffd1`.
...
- **GAP-2** — 26 live documents declare no owner. Owner assignment is a PO decision.
