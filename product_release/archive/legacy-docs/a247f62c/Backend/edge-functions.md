> ⚠️ **HISTORICAL / NON-AUTHORITATIVE.** Pinned copy of `docs/Backend/edge-functions.md` at commit `a247f62c` (2026-03-06, the last commit before its retirement). Read-only migration source — **not** current product truth. Current authority: `product_release/README.md`. Do not edit.
