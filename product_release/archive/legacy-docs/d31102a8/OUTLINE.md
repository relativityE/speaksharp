<!-- HISTORICAL / NON-AUTHORITATIVE — pinned copy of docs/OUTLINE.md at commit d31102a8 (2026-05-17). Read-only migration source; not current product truth. Current authority: product_release/README.md. Do not edit. -->

> ⚠️ **HISTORICAL / NON-AUTHORITATIVE.** Pinned copy of `docs/OUTLINE.md` at commit `d31102a8` (2026-05-17). Read-only migration source for the doc-canonicalization effort — **not** current product truth. Current authority: `product_release/README.md`. Do not edit.
