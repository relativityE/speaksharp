> ⚠️ **HISTORICAL / NON-AUTHORITATIVE.** Pinned copy of `docs/research/pricing_analysis.md` at commit `a21e1e52` (2026-03-09, the last commit before its retirement). Read-only migration source — **not** current product truth. Current authority: `product_release/README.md`. Do not edit.
