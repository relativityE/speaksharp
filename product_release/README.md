...
| 6 | **PROGRESS_AND_NEXT_ACTION.md** | Session Progress / scoring model contract (Personal Progress direction + legacy score retirement) | Product requirement / decision | `SPEAKSHARP_SESSION_PROGRESS.operational.md`, scoring material in historical `docs/PRD.md` |
