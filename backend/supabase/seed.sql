...
--
-- Test credentials:
-- Email: basic-user@test.com, Password: password123
...
VALUES
    ('00000000-0000-0000-0000-000000000000', '8a069ce3-dafa-4efa-9a2c-67bd83a3d5e8', 'authenticated', 'authenticated', 'basic-user@test.com', crypt('password123', gen_salt('bf')), now(), '', NULL, NULL, '{"provider":"email","providers":["email"]}', '{}', now(), now(), '', '', NULL, now()),
...
VALUES
    ('8a069ce3-dafa-4efa-9a2c-67bd83a3d5e8', 'basic'),
...
VALUES
    ('8a069ce3-dafa-4efa-9a2c-67bd83a3d5e8', 5, 90),   -- Basic user: defaults
    ('9a069ce3-dafa-4efa-9a2c-67bd83a3d5e9', 7, 95);   -- Pro user: higher targets

-- Print a success message
\echo "✅ Database seeded with 2 test users (basic, pro), 2 sample sessions, and user goals."
